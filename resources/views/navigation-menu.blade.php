        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('mped.index') }}" :active="request()->routeIs('mped.index')">
                        {{ __('Males') }}
                    </x-jet-nav-link>

                    <x-jet-nav-link href="{{ route('fped.index') }}" :active="request()->routeIs('fped.index')">
                        {{ __('Females') }}
                    </x-jet-nav-link>

                    <x-jet-nav-link href="{{ route('img.index') }}" :active="request()->routeIs('img.index')">
                        {{ __('Images') }}
                    </x-jet-nav-link>
