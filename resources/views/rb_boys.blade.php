<x-guest>
    <div class="mx-auto max-w-7xl">
        <div class="bg-white ">
            <p class="px-20 pt-8 text-4xl font-semibold text-center">Waiting at the Rainbow Bridge</p>
            <div class="py-4">
                    ...
                    <div class="flex flex-wrap justify-center -m-4 ">
                        @foreach ($dogs as $dog )
                            <div class="flex flex-col items-center lg:flex-row lg:w-3/5">
                                ...
                                <div class="self-center px-6 text-lg font-semibold text-gray-900 lg:basis-3/6">
                                    <a href="/dog/{{ $dog->id }}">
                                        {{ $dog->regName }}
                                    <a/>
                                </div>
                                <div class="self-center px-6 text-lg font-semibold text-gray-900 lg:basis-2/6">
                                    <a href="{{ route('show', $dog) }}">
                                        {{ $dog->callName }}'s pedigree <a/>
                                </div>
                            </div>
                        @endforeach
                    </div>
