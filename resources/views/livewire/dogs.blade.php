        ...
        <div class="overflow-hidden bg-white shadow-xl sm:rounded-lg">
            <div class="flex justify-end p-2 m-2">
                <a href="{{ route('dogs.create') }}">
                    <x-jet-button class="bg-blue-400 hover:bg-blue-600">Add Dog to List</x-jet-button>
                </a>
            </div>
            <x-search/>
            ...
            <table class="w-full whitespace-no-wrap font-robo hover:bg-gray-200">
                <thead>
                    <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b bg-[#c8d5dd]">
                        ...
                        <th class="px-4 py-2">Reg Name</th>
                        <th class="px-4 py-2">Sire</th>
                        <th class="px-4 py-2">Dame</th>
                        <th class="px-4 py-2">Birthday</th>
                        <th class="px-4 py-2 text-center">Pedigree</th>
                    ...
                    @foreach($dogs as $dog)
                        <tr class="text-gray-700 hover:bg-[#c8d5dd]">
                            ...
                            <td>
                                ...
                                <img src="images/peddy.png" alt="" class="mx-auto"></a>
                            </td>
                            <td>
