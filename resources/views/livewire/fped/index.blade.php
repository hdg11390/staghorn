    ...
    <div class="mx-auto font-serif max-w-7xl sm:px-6 lg:px-8">
        <div class="overflow-hidden bg-white shadow-xl sm:rounded-lg">
            <div class="flex justify-end p-2 m-2">
                <a href="{{ route('fped.create') }}">
                    <x-jet-button class="bg-blue-400 hover:bg-blue-600">Add Female Pedigree</x-jet-button>
                </a>
            </div>
            <x-msearch/>
                ...
                <tbody class="bg-white divide-y">
                    @foreach($fpeds as $fped)
                        <tr class="text-gray-700 hover:bg-[#c8d5dd]">
                            ...
                            <td class="px-4 py-2 text-sm">
                                @if($fped->is_active == 1)
                                    <img src="{{ asset('images/checkmark.png') }}" class="mx-auto" alt="">
                                @endif
                            </td>
                            <td>
                                <a href="#" class="text-center">
                                    <div class="mx-auto">
                                        <a href="{{ route('fped.edit', $fped) }}">
